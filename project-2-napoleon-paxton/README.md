...
# Repo Description
This repo consists of a history file, a README, a docker-compose yml file, and a Project2 notebook.<F6> 

# Assumptions
(1) This report is written as a how-to guide for data scientists that will use the service
(2) I assume the goal is to demostrate knowledge of how to spin up and use the pipeline in containers
(3) I took the less is more approach and provided short descriptions along with screenshots and suggestions for potential users (data scientists)
