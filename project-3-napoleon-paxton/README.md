...
## Assumptions
- Business questions are submitted in the form of Pyspark queries in the notebook
- Commands from queries from Presto are included to show the example business questions there as well
- Additional work to include Redis and to use a shell script to generate events are listed in Appendix 2 and 3 respectively
